...
This page documents the underlying export workflow used by the bulk export action on the proofs page.
...
Select one or more proofs in the table on the `Proofs` page, then trigger the export bulk action.
