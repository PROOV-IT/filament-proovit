...
final class ProovitProofExports extends Page implements HasTable
{
    use InteractsWithTable;

    protected static string|\BackedEnum|null $navigationIcon = 'heroicon-o-archive-box-arrow-down';

    protected static ?string $slug = 'proovit/proof-exports';

    protected static ?int $navigationSort = 16;

    public function getView(): string
    {
        return 'filament-proovit::pages.proovit-proof-exports';
    }

    public function getTitle(): string
    {
        return __('filament-proovit::filament-proovit.proof_exports.title');
    }

    public static function getNavigationLabel(): string
    {
        return __('filament-proovit::filament-proovit.proof_exports.navigation');
    }
    ...
    public function content(Schema $schema): Schema
    {
        return $schema->components([
            Section::make(__('filament-proovit::filament-proovit.proof_exports.heading'))
                ->description(__('filament-proovit::filament-proovit.proof_exports.description')),
            EmbeddedTable::make(),
        ]);
    }
    ...
    protected function getHeaderActions(): array
    {
        return [
            Action::make('refresh')
                ->label(__('filament-proovit::filament-proovit.proof_exports.actions.refresh'))
